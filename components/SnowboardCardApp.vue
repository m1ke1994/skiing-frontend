...
// Список программ по сноуборду
const courses = computed(() => mockDataStore.snowboardCourses);
...
const toggleDetails = (id) => {
  mockDataStore.toggleCourseDetails('snowboardCourses', id);
};
</script>

<template>
  <div class="course-container">
    <h1>Программы по сноуборду</h1>
